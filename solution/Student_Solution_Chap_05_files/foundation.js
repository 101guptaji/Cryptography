 ...
 function fitmathjax() {
    MathJax.Hub.Queue(function () {
        ...
        for (var i = 0; i < paras.length; i++) {
            if (paras[i].scrollWidth > document.documentElement.clientWidth) {
                var sw = paras[i].scrollWidth + 50;
                $(paras[i]).css("-webkit-transform", "scale(" + (document.documentElement.clientWidth / sw) + ")");
                $(paras[i]).css("-webkit-transform-origin", "0 0");

                $(paras[i]).css("transform", "scale(" + (document.documentElement.clientWidth / sw) + ")");
                $(paras[i]).css("transform-origin", "0 0");
            }
        }
    });
...
if ('ontouchstart' in document.documentElement)
    window.addEventListener("load", fitmathjax);
